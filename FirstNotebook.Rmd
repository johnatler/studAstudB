...
Reproduserbarhet er aktuelt i R notebook der en kan reprodusere tallmateriale så lenge en har lastet ned alle de riktige pakkene. Ved samme datasett skal en kunne få omtrentlig samme verdier om en tester datasettet ved flere anledninger inne i R Notebook. Er dette programmet likevel godt nok til å unngå feil når det kommer til reproduserbarhet?
...
Ved studier som kommer frem til et svar for å endre noe til det positive for å forbedre en ting, men samtidig ikke lykkes med dette kan gi konsekvenser. Et eksempel på dette kan være en avgift som innføres, som for eksempel at brukere av el-bil skal betale bompenger for å få inn mer penger til veiarbeid og samtidig opprettholde eller øke klimavennligheten i trafikken. Ved innføringen av et slikt studie kan gjøre at brukere av el-bil synker grunnet innføring av bompengeavgiften selv om undersøkelsen viser det motsatte.
...
=======
# Konklusjon
I denne oppgaven har vi sett på reproduserbarhet og replikerbarhet og de sine betydninger når det kommer til forskning og spesielt knyttet til R Notebooks. Dette skriveprogrammet har helt åpenbart forbedret bruken av reproduserbarhet og replikerbarhet innen forskning, men likevel er det et betydelig forbedringspotensial. Ved ytterligere og nødvendige forbedringer vil programmet kunne bli bra rustet til å gjøre reproduserbarheten og replikerbarheten enda bedre på sikt. 
