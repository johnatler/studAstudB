...
![_Her er et bilde av commits osv._](Bildet.png)

![_Merge conflict - fikset ved å rette opp i konflikt og kommando "git add ." etterpå i terminal._](MergeConflict.png)
...
![](Bildet.png)   |   _Her samme bilde av commits etc. som ovenfor._
